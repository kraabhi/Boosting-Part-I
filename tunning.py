...
#Check the accuracy on the validation data and make predictions for test data
pred_cv = model.predict(X_test)

# checking macro average F1 score
from sklearn.metrics import f1_score
f1_score(y_test , pred_cv, average='macro')

# Prediction of test data
Pred_test = model.predict(X_test_final)
f1_score(y_test_final , Pred_test, average= 'macro')

# we proceed with tuning and check for various parameters and how they are improving our accuracy metric.
...
# After tunning for this particular data I get tunned parameters as max_depth = 6 , gamma = 0 , colsample_bytree = 0.9, 
